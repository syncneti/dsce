...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['video_background_location']['mp4'] = [
      ...
      '#default_value' => !empty($this->getFileId($config->get('mp4'))) ? $this->getFileId($config->get('mp4')) : '',
    ];
    ...
    $form['video_background_location']['ogv'] = [
      ...
      '#default_value' => !empty($this->getFileId($config->get('ogv'))) ? $this->getFileId($config->get('ogv')) : '',
    ];
    ...
    $form['video_background_location']['webm'] = [
      ...
      '#default_value' => !empty($this->getFileId($config->get('webm'))) ? $this->getFileId($config->get('webm')) : '',
    ];
    ...
    $form['video_background_location']['poster'] = [
      ...
      '#default_value' => !empty($this->getFileId($config->get('poster'))) ? $this->getFileId($config->get('poster')) : '',
    ];
